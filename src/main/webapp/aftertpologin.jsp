  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="tpologin.html">Logout</a>
        </li>
      </ul>
    </div>
  </div>
...
<!-- Page Content -->
<form action="fetch2" method="post" style="margin-left: 510px; margin-top:50px;">
<input type="submit" value="Student details" class="btn btn-dark">&nbsp&nbsp&nbsp&nbsp&nbsp
<a href="companyupdation.html"><button type="button" class="btn btn-dark">Company Updation</button>  </a>
</form>
...
<hr>
<h1>Companies added till now</h1>
<br>
<table class="table">
