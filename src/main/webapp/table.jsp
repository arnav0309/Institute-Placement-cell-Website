...
Statement stmt = null;
ResultSet rs = null;
String CPI=(String)session.getAttribute("cpi");
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="log.jsp">Back</a>
        </li>
      </ul>
    </div>
  </div>
...
<h2 style="text-align:center; margin-top:25px;"><font><strong>Companies as per your CPI</strong></font></h2>
<br>
...
try{
	...
	String sql="select * from companies where CPI<=?;";
